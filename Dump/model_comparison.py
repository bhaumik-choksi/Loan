...
score1 = accuracy_score(classifier.predict(x_test), y_test)
print("KNN Classifier",score1)

classifier = DecisionTreeClassifier()
classifier.fit(x_train,y_train)
score2 = accuracy_score(classifier.predict(x_test), y_test)
print("Decision Tree Classifier",score2)

classifier = RandomForestClassifier()
classifier.fit(x_train, y_train)
score3 = accuracy_score(classifier.predict(x_test), y_test)
print("Random Forest Classifier",score3)

scores = [score1*100 - 90, score2*100 - 90, score3*100 - 90]
ind = [1,2,3]
labels = ["KNN", "DT", "RF"]
